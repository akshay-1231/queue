...
//import data_structure.Stackclass;
...
public class QueueMain {
	...
	public static void main(String[] args) {
		...
		QueueClass obj = new QueueClass();// object created System.out.println("Enter size of stack:");
		int size = sc.nextInt();
		...
		do {
			...
			case 2:
				...
				{
					System.out.println("Element exited is " + obj.Dequeue());
				}
